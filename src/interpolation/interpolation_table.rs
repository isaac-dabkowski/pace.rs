...
// Each region has a set of x/y pairs and an interpolation scheme.
// We include an interpolation fucntion that takes an x value and returns
...
pub enum InterpolationError {
    #[error("Invalid interpolation table: empty")]
    InvalidTable(),

    #[error("Interpolation region for x={0} not found")]
    RegionNotFound(f64),
}
